  ...
  <head>
    ...
    <body>
        <div class="container poppins-regular">
            ...
            <p>If you have any questions or need assistance, our customer support team is here to help. Feel free to reach out to [support@skykart.com] for prompt assistance.</p>
          
            <p>Thank you for choosing Sky Kart. We can't wait to embark on this shopping journey with you!.</p>
            <p>Best Regards,<br>The Sky Kart Team</p>
        </div>
    </body>
</html>
`;
